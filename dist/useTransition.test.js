import { areColors, getVelocityVector, hexToRgb, rgbToHex, transitionType, IS_NUMBER, IS_UNKNOWN, IS_INCOMPARABLE, IS_STRING, IS_COLOR } from './useTransition';
test('areColors()', () => {
...
test('hexToRgb()', () => {
  expect(hexToRgb("#000000")).toMatchObject({
    "b": 0,
    "g": 0,
    "r": 0
  });
  expect(hexToRgb("#ffffff")).toMatchObject({
    "b": 255,
    "g": 255,
    "r": 255
  });
